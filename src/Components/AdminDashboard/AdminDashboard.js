        ...
        <>
            <Navbar expand="lg" bg="dark" variant="dark" className="bg-body-tertiary">
                <Container>
                    ...
                    <Nav className="">
                        <Nav.Link onClick={() => handleTabChange('users')}
                                  className={activeTab === 'users' ? 'active' : ''}>Users</Nav.Link>
                        <Nav.Link onClick={() => handleTabChange('courses')}
                                  className={activeTab === 'courses' ? 'active' : ''}>Courses</Nav.Link>
                        <Nav.Link onClick={() => handleTabChange('groups')}
                                  className={activeTab === 'groups' ? 'active' : ''}>Groups</Nav.Link>
                        <Nav.Link onClick={() => handleTabChange('lessons')}
                                  className={activeTab === 'lessons' ? 'active' : ''}>Lessons</Nav.Link>
                    </Nav>
                </Container>
            </Navbar>
