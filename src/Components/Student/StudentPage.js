...
const cubeData = [
    {id: 1, label: 'Participation', link: '/student/participation', text: 'View attendance records', icon: calendarIcon},
    {id: 2, label: 'Materials', link: '/student/materials', text: 'Access learning materials', icon: materialIcon},
    {id: 3, label: 'Assignments', link: '/student/assignments', text: 'View Tasks', icon: assignmentIcon},
    {id: 4, label: 'Group', link: '/student/group', text: 'Manage group activities', icon: groupIcon},
    {id: 5, label: 'Chat', link: '/student/chat', text: 'Chat with classmates', icon: chatIcon},
];
